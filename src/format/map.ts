export const map = {
	...
	"jwt-id": {
		...
		octetLength: 16,
		octetSeparator: ".",
		includeOnly: "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_",
	},
	"bcrypt-id": {
		octets: 1,
		octetLength: 60,
		includeOnly: "./ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",
		octetSeparator: "",
	},
	"argon-id": {
		octets: 1,
